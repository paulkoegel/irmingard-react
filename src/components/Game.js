...
export default class Game extends Component {
  ...
  checkMoveable = (columnIndex, cardIndex) => {
    ...
    console.log('checkMoveable', cardIndex, columnIndex, cardIndex >= column.moveableFromIndex);
  ...
  checkOpen = (columnIndex, cardIndex) => {
    const column = this.state.gameState.columns.get(columnIndex);
    console.log('checkOpen', cardIndex, columnIndex, cardIndex >= column.openFromIndex);
